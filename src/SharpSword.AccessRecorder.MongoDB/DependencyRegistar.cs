...
namespace SharpSword.AccessRecorder.MongoDB
{
    ...
    public class DependencyRegistar : DependencyRegistarBase
    {
        ...
        {
            containerBuilder.Register(c => new AccessRecorderMongoClient(c.Resolve<AccessRecorderConfig>().ConnectionString))
                            .SingleInstance();
        }
        ...
        /// 数字越大越后注册
        /// </summary>
        public override int Priority => base.DefaultPriority + 100;
    }
}
