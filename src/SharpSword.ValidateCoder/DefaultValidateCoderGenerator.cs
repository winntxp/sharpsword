...
namespace SharpSword.ValidateCoder
{
    ...
    /// 默认的验证码生成类
    /// </summary>
    public class DefaultValidateCoderGenerator : IValidateCoderGenerator
    {
        /// <summary>
        /// 
        /// </summary>
        ...
        /// <returns></returns>
        public ValidateCoderResult Generator(int length, ValidateCodeType codeType = ValidateCodeType.NumberAndLetter)
        {
            var code = this.GetCode(length, codeType);
            return new ValidateCoderResult(code, this.CreateImage(code, codeType));
        }
        ...
        /// 获取指定长度的验证码字符串
        /// </summary>
        protected string GetCode(int length, ValidateCodeType codeType = ValidateCodeType.NumberAndLetter)
        {
            switch (codeType)
            {
        ...
        /// 获取指定字符串的验证码图片
        /// </summary>
        protected Bitmap CreateImage(string code, ValidateCodeType codeType)
        {
        ...
        /// 获取指定长度的验证码图片
        /// </summary>
        private Bitmap CreateImage(int length, out string code, ValidateCodeType codeType = ValidateCodeType.NumberAndLetter)
        {
